...
MINIO_REGION=CHANGE_TO_REGION
MINIO_ENDPOINT=CHANGE_TO_YOUR_S3_DOMAIN_NAME
...
MINIO_USE_SSL=true
MINIO_BUCKET=mybucket
MINIO_REGION=changemedsdsdsdsdsdd.test (change this)
MINIO_ENDPOINT=changemedsdsd.test (change this)
MINIO_ACCESS_KEY=CHANGE_TO_YOUR_ACCESS_KEY
MINIO_SECRET_KEY=CHANGE_TO_YOUR_SECRET_KEY
```
